...
#define IMGUI_DEBUG_LOG_ENGINE(...)     do { if (g.DebugLogFlags & ImGuiDebugLogFlags_EventEngine)   IMGUI_DEBUG_LOG(__VA_ARGS__); } while (0)  //To Remove
...
enum ImGuiDebugLogFlags_
{
    ...
    ImGuiDebugLogFlags_EventEngine      = 1 << 9,       //To Remove
    ImGuiDebugLogFlags_EventMask_       = ImGuiDebugLogFlags_EventActiveId | ImGuiDebugLogFlags_EventFocus | ImGuiDebugLogFlags_EventPopup | ImGuiDebugLogFlags_EventNav | ImGuiDebugLogFlags_EventClipper | ImGuiDebugLogFlags_EventSelection | ImGuiDebugLogFlags_EventIO | ImGuiDebugLogFlags_EventDocking | ImGuiDebugLogFlags_EventViewport | ImGuiDebugLogFlags_EventEngine,      //To Remove
    ...
    ImGuiDebugLogFlags_OutputToTTY      = 1 << 11,  // Also send output to TTY
};
