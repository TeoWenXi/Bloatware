...
void UIButtonExitMenu::OnClick()
{
	...
	LevelLoader::LoadPrefab("ExitMenu Prefab");
}

void UIButtonExitMenu::OnHoverEnter()
{
...
void UIButtonExitMenu::OnHoverExit()
{
	GameUITextHandler* _textHandler = EntityManager::GetInstance()->GetEntity(mEntID)->GetComponent<GameUITextHandler>();
	if (_textHandler != nullptr)
	{
